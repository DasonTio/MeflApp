...
class _MenuAddPageState extends State<MenuAddPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MenuAddBloc, MenuAddState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: BlocBuilder<MenuAddBloc, MenuAddState>(
                  ...
                  formField(
                    onChange: (value) {
                      context
                          .read<MenuAddBloc>()
                          .add(ChangeMenuNameEvent(name: value));
                    },
                  ...
                  dropDownField(onChange: (value) {
                    ...
                    context
                        .read<MenuAddBloc>()
                        .add(ChangeMenuCategoryEvent(category: value));
                  }),
                  SizedBox(
                    height: SizeConfig.blockVertical,
                  ),
                  ...
                  formField(
                    onChange: (value) {
                      context.read<MenuAddBloc>().add(
                          ChangeMenuPriceEvent(price: num.parse(value ?? 0)));
                    },
                    hintText: "Rp.0",
                    numberType: true,
                  ),
                        ...
                        paddingContent(
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                context.read<MenuAddBloc>().add(AddMenuEvent());
                              },
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            // context
            //     .read<MenuAddBloc>()
            //     .add(ChangeMenuCategoryEvent(category: data[0].categoryId!));
