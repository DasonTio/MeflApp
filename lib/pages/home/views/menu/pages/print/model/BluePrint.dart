...
class BluePrint {
  ...
  Future<List<BluetoothCharacteristic>> _getCharacteristic(
  ...
  Future<void> printData(BluetoothDevice device) async {
    ...
    final characs = await _getCharacteristic(device);
  ...
  Future<bool> _tryPrint(
      BluetoothCharacteristic charac, List<List<int>> data) async {
